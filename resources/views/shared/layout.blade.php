...
<body class="bg-blue-100">
    ...
    <nav class="bg-gray-800 py-4 fixed w-full z-10 top-0">
        ...
        <div class="text-white font-bold mb-4 sm:mb-0 sm:mr-4 flex flex-col sm:flex-row">
            ...
            <a href="{{ route('statistics.index') }}" class="text-white text-4xl sm:text-xl block sm:inline-block mb-4 sm:mb-0 mr-4 hover:text-indigo-400"">{{ __('statistics.statistics') }}</a>
