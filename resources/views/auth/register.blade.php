...
<body class="bg-blue-100 flex justify-center items-center h-screen">
    <div class="bg-white p-8 rounded w-full min-h-screen sm:min-h-0 max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl md:shadow-md sm:-mt-64 relative">
        <a href="{{ route('login') }}" class="absolute top-2 right-2 text-indigo-600 hover:text-indigo-800 text-sm font-medium">Already got an account? Login.</a>
